...
FILES_${PN} += "${systemd_unitdir}/system/tacaman.service"

SYSTEMD_SERVICE_${PN} = "tacaman.service"
...
USERADD_PACKAGES = "${PN}"
USERADD_PARAM_${PN} = "-r -N -g tacaman strbo-tacaman"
GROUPADD_PARAM_${PN} = "-r tacaman"
